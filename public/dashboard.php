      ...
      <div class="row mt-4">
        <div class="col-md-6">
          <div class="card border-primary mb-3">
            <div class="card-body">
              <h5 class="card-title">Manage Guardrails</h5>
              <p class="card-text">View, edit, and save YAML-based guardrails.</p>
            </div>
          </div>
        </div>
        <div class="col-md-6">
          <div class="card border-secondary mb-3">
            <div class="card-body">
              <h5 class="card-title">Manage Personas</h5>
              <p class="card-text">Edit personas that shape model behavior and interaction logic.</p>
            </div>
          </div>
        </div>
      </div>
